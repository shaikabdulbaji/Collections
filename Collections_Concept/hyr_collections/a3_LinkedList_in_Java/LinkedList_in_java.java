 ...
 * Important points to remember :
   ...
   * main ga LinkedList lo 2 types untai avi amiti antea 
     1. singly LinkedList.
     2. doublely LinkedList.
     
     singly LinkedList lo only next aneadi untundi danitho only forward a untundi.
     doublely LinkedList lo prev and next ani two untai danitho backward and forward rendu aavutai.
