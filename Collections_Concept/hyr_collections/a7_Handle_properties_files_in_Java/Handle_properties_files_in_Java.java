...
//		System.out.println(file.exists());
		...
		*/
		/*
		//some additional properties --> evani map lo vi.
		prop.put(prop, fis);
		prop.clear();
		prop.size();
		prop.isEmpty();
		prop.containsKey(fis);
		prop.replace(prop, fis);
		*/
	}
